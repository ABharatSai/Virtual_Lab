...
{
"id": 2,
"question": "Which of the following statements are true regarding primary structure of proteins?",
"options": [
{
...
{
    "id": 5,
    "question": "Which of the following is the most common and stable conformation for a polypeptide chain?",
    "options": [
    {
    "a": "Alpha helix",
...
{
    "id": 6,
    "question": "The amyloid protein deposition associated with Alzheimer's disease is composed of",
    "options": [
    {
    "a": "Alpha helix",
    "b": "Beta pleated sheets",
    ...
    },
{
    ...
    "answer": "Carbonyl oxygen of one peptide bond to the NH group of the 4th amino acid away",
    "score": 0,
    "status": ""
    },
{
    "id": 8,
    "question": "Which of the following statements are true regarding tertiary structure of proteins?",
    "options": [
    {
...
{
    "id": 10,
    "question": "Which of the following statements are true regarding quaternary structure of protein?",
    "options": [
    {
    ...
    "answer": "Refers to organisation and spatial arrangements of proteins with many polypeptide chains",
    "score": 0,
    "status": ""
    },
